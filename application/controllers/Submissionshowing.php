...
class Submissionshowing extends CI_Controller {
	 ...
	 */
	public function index($contest_id, $sub_id)//selected contest id
	{
		...
		$data['submission']= $this->sub->get_submission($sub_id);
		$data['code']= read_file($data['submission']->code_file_path);
		...
		$this->load->view('submissionshowing',$data);
