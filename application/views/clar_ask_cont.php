...
<html lang="en">
  <head>
    ...
    <title>Ask New Clarification</title>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
              <div class="row mt">
                  <div class="col-md-12">
                    <form method="post" action="<?php echo site_url('clarification/save/'.$contest_id.'/'.$clar_id.'/');?>">
                      <h3><i class="fa fa-angle-right"></i> Submit Question</h3>
