...
<html lang="en">
  <head>
    ...
    <title>Submission Showing</title>
    ...
    <script type="text/javascript" src="<?php echo base_url('scripts/shBrushCpp.js') ?>"></script>
    <link type="text/css" rel="stylesheet" href="<?php echo base_url('styles/shCoreDefault.css') ?>"/>
              ...
              <div class="row mt">
                  <div class="col-md-12">
                      <div class="content-panel">
                        <!--  /////////////////////////////////////Submission showing code///////////////////////////////////////////// -->
                        <div style="position: relative;" class="panel-body">
                          <div class="h1">Code of Submission#<?=$submission->submission_id;?> by <?=$submission->username;?></div>
                          <p class="h4">Problem: <?=$submission->problem_name;?> (#<?=$submission->problem_id;?>)</p>
                          <p class="h4">Contest: <?=$contest_name;?> (#<?=$contest_id;?>)</p>
                          <p class="h4">Submission Time: <?=unix_to_human(human_to_unix($submission->submission_time));?></p>
                          <p class="h4">Language: <?=$submission->language;?>   Verdict: <?=$submission->verdict;?> </p><br>
                          <pre class="brush: cpp"><?=$code;?></pre>
